...
function C(t2) {
  ...
  function L2(t3, n2) {
    ...
    N2 && C2.count++;
    const M2 = { ...I3, ...i2, toastId: l3, updateId: c2, data: T3, closeToast: L3, isIn: false, key: i2.key || C2.toastKey++, className: m(i2.className || I3.toastClassName), bodyClassName: m(i2.bodyClassName || I3.bodyClassName), progressClassName: m(i2.progressClassName || I3.progressClassName), autoClose: !i2.isLoading && (R2 = i2.autoClose, w2 = I3.autoClose, false === R2 || u(R2) && R2 > 0 ? R2 : w2), deleteToast() {
...
var N = (n2) => {
  const { isRunning: o2, preventExitTransition: s2, toastRef: r3, eventHandlers: i2 } = _(n2), { closeButton: l2, children: u2, autoClose: d2, onClick: m2, type: f2, hideProgressBar: g2, closeToast: h2, transition: y2, position: v2, className: T2, style: E2, bodyClassName: C2, bodyStyle: I2, progressClassName: b2, progressStyle: N2, updateId: M2, role: R2, progress: w2, rtl: x2, toastId: k2, deleteToast: $2, isIn: P2, isLoading: B2, iconOut: D2, closeOnClick: A2, theme: z2 } = n2, F2 = clsx_m_default("Toastify__toast", `Toastify__toast-theme--${z2}`, `Toastify__toast--${f2}`, { "Toastify__toast--rtl": x2 }, { "Toastify__toast--close-on-click": A2 }), H2 = p(T2) ? T2({ rtl: x2, position: v2, type: f2, defaultClassName: F2 }) : clsx_m_default(F2, T2), q2 = !!w2 || !d2, S2 = { closeToast: h2, type: f2, theme: z2 };
  let Q2 = null;
  return false === l2 || (Q2 = p(l2) ? l2(S2) : (0, import_react.isValidElement)(l2) ? (0, import_react.cloneElement)(l2, S2) : L(S2)), import_react.default.createElement(y2, { isIn: P2, done: $2, position: v2, preventExitTransition: s2, nodeRef: r3 }, import_react.default.createElement("div", { id: k2, onClick: m2, className: H2, ...i2, style: E2, ref: r3 }, import_react.default.createElement("div", { ...P2 && { role: R2 }, className: p(C2) ? C2({ type: f2 }) : clsx_m_default("Toastify__toast-body", C2), style: I2 }, null != D2 && import_react.default.createElement("div", { className: clsx_m_default("Toastify__toast-icon", { "Toastify--animate-icon Toastify__zoom-enter": !B2 }) }, D2), import_react.default.createElement("div", null, u2)), Q2, import_react.default.createElement(O, { ...M2 && !q2 ? { key: `pb-${M2}` } : {}, rtl: x2, theme: z2, delay: d2, isRunning: o2, isIn: P2, closeToast: h2, hide: g2, type: f2, style: N2, className: b2, controlledProgress: q2, progress: w2 || 0 })));
};
...
var x = h(M("zoom"));
var k = h(M("flip"));
var $ = (0, import_react.forwardRef)((e2, n2) => {
...
$.displayName = "ToastContainer", $.defaultProps = { position: "top-right", transition: R, autoClose: 5e3, closeButton: L, pauseOnHover: true, pauseOnFocusLoss: true, closeOnClick: true, draggable: true, draggablePercent: 80, draggableDirection: "x", role: "alert", theme: "light" };
var P;
...
function S(t2) {
  return (e2, n2) => H(e2, q(t2, n2));
}
function Q(t2, e2) {
  return H(t2, q("default", e2));
}
Q.loading = (t2, e2) => H(t2, q("default", { isLoading: true, autoClose: false, closeOnClick: false, closeButton: false, draggable: false, ...e2 })), Q.promise = function(t2, e2, n2) {
...
}, Q.success = S("success"), Q.info = S("info"), Q.error = S("error"), Q.warning = S("warning"), Q.warn = Q.warning, Q.dark = (t2, e2) => H(t2, q("default", { theme: "dark", ...e2 })), Q.dismiss = (t2) => {
